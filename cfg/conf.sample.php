...
; config file for Zbin
;
; An explanation of each setting can be find online at https://github.com/zbin/wiki/Configuration.
...
; Zbin files, including an ending slash (/). This URL is essential to
; allow Opengraph images to be displayed on social networks.
; basepath = "https://zbin.example.com/"
...
; by default Zbin use "bootstrap5" template (tpl/bootstrap5.php).
...
; by default Zbin will guess the visitors language based on the browsers
...
;   policy here. See https://github.com/zbin/wiki/FAQ#why-does-not-it-load-embedded-images
;   for details.
...
; See https://github.com/zbin/wiki/FAQ#why-does-it-show-me-an-error-about-an-insecure-connection for more information.
; httpwarning = true
...
;   "urlshortener" needs to point to the base URL of your Zbin
...
;   credentials, and will be visible in public on the Zbin web page.
;   Only use this if you allow short URL creation without credentials.
; - Alternatively, using the parameters in this section ("signature" and
;   "apiurl"), "urlshortener" needs to point to the base URL of your Zbin
...
; signature = ""
; (optional) the URL of the YOURLS API, called to shorten a Zbin URL
; apiurl = "https://yourls.example.com/yourls-api.php"

;[sri]
; Subresource integrity (SRI) hashes used in template files. Uncomment and set
; these for all js files used. See:
; https://github.com/zbin/wiki/FAQ#user-content-how-to-make-zbin-work-when-i-have-changed-some-javascript-files
;js/zbin.js = "sha512-[…]"
