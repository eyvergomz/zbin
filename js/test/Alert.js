    ...
    describe('showStatus', function () {
        jsc.property(
            ...
            function (icon, message) {
                ...
                $.Zbin.Alert.init();
                $.Zbin.Alert.showStatus(message, icon);
    ...
    describe('showWarning', function () {
        jsc.property(
            ...
            function (icon, message) {
                ...
                $.Zbin.Alert.init();
                $.Zbin.Alert.showWarning(message, icon);
                const result = $('body').html();
                return expected === result;
            }
        );
        ...
        jsc.property(
            ...
            function (message) {
                ...
                $.Zbin.Alert.init();
                $.Zbin.Alert.showWarning(message);
                const result = $('body').html();
                return expected === result;
            }
        );
    ...
    describe('showError', function () {
        jsc.property(
            ...
            function (icon, message) {
                ...
                $.Zbin.Alert.init();
                $.Zbin.Alert.showError(message, icon);
                const result = $('body').html();
                return expected === result;
            }
        );
    ...
    describe('showRemaining', function () {
        jsc.property(
            ...
            function (message, string, number) {
                ...
                $.Zbin.Alert.init();
                $.Zbin.Alert.showRemaining(['%s' + message + '%d', string, number]);
                const result = $('body').html();
                return expected === result;
            }
        );
    ...
    describe('showLoading', function () {
        jsc.property(
            ...
            function (message, icon) {
                ...
                $.Zbin.Alert.init();
                $.Zbin.Alert.showLoading(message, icon);
                const result = $('body').html();
                return expected === result;
            }
        );
        ...
        jsc.property(
            ...
            function (trigger, message) {
                ...
                let handlerCalled = false,
                    ...
                    functions = [
                        $.Zbin.Alert.showStatus,
                        $.Zbin.Alert.showError,
                        $.Zbin.Alert.showRemaining,
                        $.Zbin.Alert.showLoading
                    ];
                if (message.length === 0) {
                    message = defaultMessage;
                }
                ...
                $.Zbin.Alert.init();
                $.Zbin.Alert.setCustomHandler(function(id, $element) {
                    handlerCalled = true;
                    return jsc.random(0, 1) ? true : $element;
                });
                functions[trigger](message);
                $.Zbin.Alert.setCustomHandler(null);
