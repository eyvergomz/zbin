    ...
    describe('createPasteNotification', function () {
        ...
        jsc.property(
            ...
            function (url1, url2) {
                ...
                $.Zbin.PasteStatus.init();
                $.Zbin.PasteStatus.createPasteNotification(expected1, expected2);
    ...
    describe('extractUrl', function () {
        ...
        jsc.property(
            ...
            function (schema, domain, url) {
                ...
                $.Zbin.PasteStatus.init();
                $.Zbin.PasteStatus.createPasteNotification('', '');
                $.Zbin.PasteStatus.extractUrl(urlString);
        ...
        jsc.property(
            ...
            function (schema, longUrl, shortUrl) {
                ...
                $.Zbin.PasteStatus.init();
                $.Zbin.PasteStatus.createPasteNotification('', '');
                $.Zbin.PasteStatus.extractUrl(JSON.stringify(yourlsResponse, undefined, 4));
        ...
        jsc.property(
            ...
            function (schema, longUrl, shortUrl) {
                ...
                $.Zbin.PasteStatus.init();
                $.Zbin.PasteStatus.createPasteNotification('', '');
                $.Zbin.PasteStatus.extractUrl(yourlsResponse);
    ...
    describe('showRemainingTime', function () {
        ...
        jsc.property(
            ...
            function (burnafterreading, remainingTime, url) {
                ...
                $.Zbin.PasteStatus.init();
                $.Zbin.PasteStatus.showRemainingTime($.Zbin.Helper.PasteFactory({
