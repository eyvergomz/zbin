...
describe('I18n', function () {
    describe('translate', function () {
        ...
        jsc.property(
            ...
            function (messageId) {
                ...
                var plurals = [messageId, messageId + 's'],
                    fake    = [messageId],
                    result  = $.Zbin.I18n.translate(messageId);
                $.Zbin.I18n.reset();

                var alias = $.Zbin.I18n._(messageId);
                $.Zbin.I18n.reset();

                var pluralResult = $.Zbin.I18n.translate(plurals);
                $.Zbin.I18n.reset();

                var pluralAlias = $.Zbin.I18n._(plurals);
                $.Zbin.I18n.reset();

                var fakeResult = $.Zbin.I18n.translate(fake);
                $.Zbin.I18n.reset();

                var fakeAlias = $.Zbin.I18n._(fake);
                $.Zbin.I18n.reset();

                if (messageId.indexOf('<a') === -1) {
                    messageId = $.Zbin.Helper.htmlEntities(messageId);
                } else {
        ...
        jsc.property(
            ...
            function (prefix, params, postfix) {
                ...
                const translation = $.Zbin.Helper.htmlEntities(prefix + params[0] + postfix);
                params.unshift(prefix + '%s' + postfix);
                const result = $.Zbin.I18n.translate.apply(this, params);
                $.Zbin.I18n.reset();
                const alias = $.Zbin.I18n._.apply(this, params);
                $.Zbin.I18n.reset();
        ...
        jsc.property(
            ...
            function (prefix, params, postfix) {
                ...
                args.unshift($('#i18n'));
                $.Zbin.I18n.translate.apply(this, args);
    ...
    describe('getPluralForm', function () {
        ...
        jsc.property(
            ...
            'integer',
            function(language, n) {
                $.Zbin.I18n.reset(language);
                var result = $.Zbin.I18n.getPluralForm(n);
    ...
    describe('loadTranslations', function () {
        ...
        jsc.property(
            ...
            function(language) {
                ...
                $.Zbin.I18n.reset('en');
                $.Zbin.I18n.loadTranslations();
                clean();

                // mock
                clean = jsdom('', {cookie: ['lang=' + language]});
                // eslint-disable-next-line global-require
                $.Zbin.I18n.reset(language, require('../../i18n/' + language + '.json'));
                var loadedLang = $.Zbin.I18n.getLanguage(),
                    result = $.Zbin.I18n.translate('Never'),
                    alias  = $.Zbin.I18n._('Never');
                clean();
        ...
        jsc.property(
            ...
            function() {
                var clean = jsdom('', {url: 'https://zbin.net/'});
                ...
                $.Zbin.I18n.reset('en');
                $.Zbin.I18n.loadTranslations();
                var result = $.Zbin.I18n.translate('Never'),
                    alias  = $.Zbin.I18n._('Never');
