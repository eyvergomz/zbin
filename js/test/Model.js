    ...
    describe('getExpirationDefault', function () {
        ...
        jsc.property(
            ...
            function (keys, value, key) {
                keys = keys.map($.Zbin.Helper.htmlEntities);
                value = $.Zbin.Helper.htmlEntities(value);
                ...
                contents += '</select>';
                $('body').html(contents);
                var result = $.Zbin.Helper.htmlEntities(
                    $.Zbin.Model.getExpirationDefault()
                );
                $.Zbin.Model.reset();
    ...
    describe('getPasteId', function () {
        ...
        jsc.property(
            ...
            function (url, pasteId, queryStart, queryEnd) {
                ...
                const result = $.Zbin.Model.getPasteId();
                $.Zbin.Model.reset();
                clean();
    ...
    describe('getPasteKey', function () {
        ...
        jsc.property(
            ...
            function (url, trail) {
                ...
                url.fragment = $.Zbin.CryptTool.base58encode(fragment) + '&' + trail.join('');
                const clean = jsdom('', {url: common.urlToString(url)}),
                    result = $.Zbin.Model.getPasteKey();
                $.Zbin.Model.reset();
                clean();
        ...
        jsc.property(
            ...
            function (url) {
                ...
                const fragment = url.fragment.padStart(32, '\u0000');
                url.fragment = $.Zbin.CryptTool.base58encode(fragment);
                const clean = jsdom('', {url: common.urlToString(url)}),
                    result = $.Zbin.Model.getPasteKey();
                $.Zbin.Model.reset();
                clean();
        ...
        jsc.property(
            ...
            function (id, element, value) {
                ...
                var template = '<' + element + ' id="' + id + '">' + value +
                    '</' + element + '>',
                    result = $.Zbin.Model.getTemplate(id).wrap('<p/>').parent().html();
                $.Zbin.Model.reset();
