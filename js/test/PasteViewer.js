    ...
    describe('run, hide, getText, setText, getFormat, setFormat & isPrettyPrinted', function () {
        ...
        jsc.property(
            ...
            function (format, text) {
                ...
                $.Zbin.PasteViewer.setText('');
                results.push(
                    $('#placeholder').hasClass('hidden') &&
                    $('#prettymessage').hasClass('hidden') &&
                    $('#plaintext').hasClass('hidden') &&
                    $.Zbin.PasteViewer.getFormat() === format &&
                    $.Zbin.PasteViewer.getText() === ''
                );
                ...
                results.push(
                    $('#placeholder').hasClass('hidden') &&
                    !$.Zbin.PasteViewer.isPrettyPrinted() &&
                    $.Zbin.PasteViewer.getText() === text
                );
                if (format === 'markdown') {
                    results.push(
                        $('#prettymessage').hasClass('hidden') &&
