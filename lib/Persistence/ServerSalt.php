 ...
 * ServerSalt
 *
 * This is a random string which is unique to each Zbin installation.
 * It is automatically created if not present.
 *
 * Salt is used:
 * - to generate unique VizHash in discussions (which are not reproductible across Zbin servers)
 * - to generate unique deletion token (which are not re-usable across Zbin servers)
 */
