...
<html lang="<?php echo I18n::getLanguage(); ?>"<?php echo I18n::isRtl() ? ' dir="rtl"' : ''; ?> class="h-100">
	<head>
		...
		<link type="text/css" rel="stylesheet" href="css/bootstrap5/zbin.css?<?php echo rawurlencode($VERSION); ?>" />
<?php
...
?>
		...
		<?php $this->_scriptTag('js/zbin.js', 'defer'); ?>
		<!-- icon -->
				...
				<div class="modal-content">
					<div class="modal-body">
						<form id="passwordform" role="form">
							<div class="mb-4">
								<label for="passworddecrypt" class="form-label mb-2">
							...
							<div class="d-grid">
								<button type="submit" class="btn btn-success">
									<svg width="16" height="16" fill="currentColor" aria-hidden="true"><use href="img/bootstrap-icons.svg#power" /></svg>
			...
			<div class="modal-dialog modal-dialog-centered" role="document">
				<div class="modal-content">
					...
					<div class="modal-body text-center">
						<button id="loadconfirm-open-now" type="button" class="btn btn-success" data-bs-dismiss="modal">
							<svg width="16" height="16" fill="currentColor" aria-hidden="true"><use href="img/bootstrap-icons.svg#cloud-download" /></svg>
							<?php echo I18n::_('Yes, see it') ?>
						</button>
					</div>
				</div>
			</div>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						<div class="d-flex flex-column flex-md-row gap-2 justify-content-center">
							<button id="emailconfirm-timezone-current" type="button" class="btn btn-danger d-flex justify-content-center align-items-center gap-1">
								<svg width="16" height="16" fill="currentColor" aria-hidden="true"><use href="img/bootstrap-icons.svg#clock" /></svg>
								<?php echo I18n::_('Use Current Timezone') ?>
							</button>
							<button id="emailconfirm-timezone-utc" type="button" class="btn btn-success d-flex justify-content-center align-items-center gap-1">
								<svg width="16" height="16" fill="currentColor" aria-hidden="true"><use href="img/bootstrap-icons.svg#globe" /></svg>
								<?php echo I18n::_('Convert To UTC') ?>
							</button>
						</div>
					</div>
				</div>
		...
		<nav class="navbar navbar-expand-lg text-nowrap">
			<div class="container-fluid">
				<a class="reloadlink navbar-brand" href="">
					<img alt="<?php echo I18n::_($NAME); ?>" src="img/icon.svg" height="34" />
				</a>
...
?>
				...
				<div id="oldnotice" role="alert" class="hidden alert alert-danger">
					...
					<span class="small"><?php echo I18n::_('For more information <a href="%s">see this FAQ entry</a>.', 'https://github.com/zbin/wiki/FAQ#why-does-it-show-me-the-error-zbin-requires-a-modern-browser-to-work'); ?></span>
				</div>
<?php
if ($HTTPWARNING) :
?>
				<div id="httpnotice" role="alert" class="hidden alert alert-danger">
					...
					<span class="small"><?php echo I18n::_('For more information <a href="%s">see this FAQ entry</a>.', 'https://github.com/zbin/wiki/FAQ#why-does-it-show-me-an-error-about-an-insecure-connection'); ?></span>
				</div>
...
?>
				<div id="pastesuccess" class="hidden">
					<div class="d-flex justify-content-between align-items-center mb-3">
						<button id="copyLink" type="button" class="btn btn-primary d-flex justify-content-center align-items-center gap-1">
						...
						<a href="#" id="deletelink" class="btn btn-danger d-flex justify-content-center align-items-center gap-1">
...
?>
			...
			<section class="container-fluid">
				<div id="noscript" role="alert" class="alert alert-info noscript-hide">
					...
					<span class="small"><?php echo I18n::_('In case this message never disappears please have a look at <a href="%s">this FAQ for information to troubleshoot</a>.', 'https://github.com/zbin/wiki/FAQ#why-does-the-loading-message-not-go-away'); ?></span>
				</div>
			</section>
		</main>
		<!-- Footer -->
